...
def scatter_max(
    ...
    Returns:
        tuple: A tuple of (out, argmax) where out is the result tensor and
            argmax is the indices of the maximum values.
    """
    return torch.ops.xav_dsal.scatter_max(src, index, dim, out, dim_size, offset, offset_reduce)